...
<br><br><h1 align="center">Languages and Frameworks</h1>[![TS, React, NEXT](https://skillicons.dev/icons?i=html,css,js,ts,react,typescript,nextjs,java,c,cpp,python,spring,php,kotlin,go,nodejs,expressjs)]()
<br><br><h1 align="center">Databases and Tools</h1>[![TS, React, NEXT](https://skillicons.dev/icons?i=mongodb,mysql,terraform,kubernetes,docker,)]()
